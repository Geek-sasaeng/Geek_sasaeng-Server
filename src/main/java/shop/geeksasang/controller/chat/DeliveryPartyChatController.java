...
public class DeliveryPartyChatController {
    ...
    public BaseResponse<String> createChatImage(HttpServletRequest request, @ModelAttribute @Validated PostChatImageReq dto){
        JwtInfo jwtInfo = (JwtInfo) request.getAttribute("jwtInfo");
        deliveryPartyChatService.createChatImage(jwtInfo.getUserId(), dto.getChatRoomId(), dto.getContent(), dto.getIsSystemMessage(), dto.getChatType(), dto.getChatId(), dto.getImages(), dto.getIsImageMessage());
