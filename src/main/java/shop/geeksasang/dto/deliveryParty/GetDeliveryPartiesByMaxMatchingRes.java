...
@Setter
@Builder
public class GetDeliveryPartiesByMaxMatchingRes {
    ...
    static public GetDeliveryPartiesByMaxMatchingRes toDto(DeliveryParty deliveryParty) {

        return GetDeliveryPartiesByMaxMatchingRes.builder()
