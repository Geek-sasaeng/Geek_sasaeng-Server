...
@Setter
@Builder
public class GetDeliveryPartiesByConditionsRes {
    ...
    //빌더
    static public GetDeliveryPartiesByConditionsRes toDto(DeliveryParty deliveryParty){
        return GetDeliveryPartiesByConditionsRes.builder()
