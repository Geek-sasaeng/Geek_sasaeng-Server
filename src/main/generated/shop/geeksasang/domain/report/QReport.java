...
public class QReport extends EntityPathBase<Report> {
    ...
    public QReport(Class<? extends Report> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reportingMember = inits.isInitialized("reportingMember") ? new shop.geeksasang.domain.member.QMember(forProperty("reportingMember"), inits.get("reportingMember")) : null;
    }
