...
public class QDeliverPartyReportRecord extends EntityPathBase<DeliverPartyReportRecord> {
    ...
    public final shop.geeksasang.domain.deliveryparty.QDeliveryParty reportedDeliveryParty;
    ...
    public QDeliverPartyReportRecord(Class<? extends DeliverPartyReportRecord> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reportedDeliveryParty = inits.isInitialized("reportedDeliveryParty") ? new shop.geeksasang.domain.deliveryparty.QDeliveryParty(forProperty("reportedDeliveryParty"), inits.get("reportedDeliveryParty")) : null;
