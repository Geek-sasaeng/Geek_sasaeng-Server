...
public class QBlock extends EntityPathBase<Block> {
    ...
    private static final long serialVersionUID = -172157473L;
    ...
    public final shop.geeksasang.domain.member.QMember blockedMember;

    public final shop.geeksasang.domain.member.QMember blockingMember;
    ...
    public QBlock(Class<? extends Block> type, PathMetadata metadata, PathInits inits) {
        ...
        this.blockedMember = inits.isInitialized("blockedMember") ? new shop.geeksasang.domain.member.QMember(forProperty("blockedMember"), inits.get("blockedMember")) : null;
        this.blockingMember = inits.isInitialized("blockingMember") ? new shop.geeksasang.domain.member.QMember(forProperty("blockingMember"), inits.get("blockingMember")) : null;
    }
