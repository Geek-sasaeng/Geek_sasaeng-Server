...
public class QDeliveryPartyMember extends EntityPathBase<DeliveryPartyMember> {
    ...
    private static final long serialVersionUID = 1620106691L;
    ...
    public final EnumPath<shop.geeksasang.config.status.AccountTransferStatus> acccountTransferStatus = createEnum("acccountTransferStatus", shop.geeksasang.config.status.AccountTransferStatus.class);
    ...
    public final ListPath<DeliveryPartyMenu, QDeliveryPartyMenu> menuList = this.<DeliveryPartyMenu, QDeliveryPartyMenu>createList("menuList", DeliveryPartyMenu.class, QDeliveryPartyMenu.class, PathInits.DIRECT2);

    public final shop.geeksasang.domain.member.QMember participant;
    ...
    public QDeliveryPartyMember(Class<? extends DeliveryPartyMember> type, PathMetadata metadata, PathInits inits) {
        ...
        this.participant = inits.isInitialized("participant") ? new shop.geeksasang.domain.member.QMember(forProperty("participant"), inits.get("participant")) : null;
